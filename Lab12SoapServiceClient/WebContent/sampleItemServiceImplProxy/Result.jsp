...
<%
        ...
        if(getAllItems41mtemp != null){
        java.util.List<com.journaldev.jaxws.beans.SoapService>  listreturnp42= java.util.Arrays.asList(getAllItems41mtemp);
        //tempreturnp42 = listreturnp42.toString();
        for(com.journaldev.jaxws.beans.SoapService p : listreturnp42){
